...
const (
	...
	RequestMessage_COPY      RequestMessage_RequestType = 2
	RequestMessage_KEEPALIVE RequestMessage_RequestType = 3
)
...
const (
	ResponseMessage_STDOUT ResponseMessage_ResponseType = 1
	ResponseMessage_STDERR ResponseMessage_ResponseType = 2
	ResponseMessage_CLOSE  ResponseMessage_ResponseType = 3
	ResponseMessage_PING   ResponseMessage_ResponseType = 4
	ResponseMessage_COPY   ResponseMessage_ResponseType = 5
)
